...
class CustomPrintPageRenderer: UIPrintPageRenderer {
    ...
    override func drawHeaderForPage(at pageIndex: Int, in headerRect: CGRect) {
        ...
        let headerText: NSString = "FACTURE"
        ...
        let textAttributes = [NSAttributedString.Key.font.rawValue: font!, NSAttributedString.Key.foregroundColor: UIColor(red: 243.0/255, green: 82.0/255.0, blue: 30.0/255.0, alpha: 1.0),
                              NSAttributedString.Key.kern: 7.5] as! [NSAttributedString.Key : Any]
